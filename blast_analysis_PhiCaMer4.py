...
names_phi = ["chlorella_variabilis.phiscan","auxenochlorella_protothecoides.phiscan","helicosporidium_sp.phiscan","trichophyton_rubrum.phiscan","candida_albicans.phiscan"]

#nazwy plików wynikowych blast z bazą merops
names_merops = ["chlorella_variabilis.merops","auxenochlorella_protothecoides.merops","helicosporidium_sp.merops","trichophyton_rubrum.merops","candida_albicans.merops"]

#nazwy plików wynikowych blast z bazą cazy
names_cazy = ["chlorella_variabilis.cazy","auxenochlorella_protothecoides.cazy","helicosporidium_sp.cazy","trichophyton_rubrum.cazy","candida_albicans.cazy"]
...
db_names = ["phi_accessions.fastat","merops_scan.fasta","CAZyDB.fasta"]
