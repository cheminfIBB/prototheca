...
names = ["prototheca.fasta.tsv"]
#"chlorella_variabilis.faa.tsv","trichophyton_rubrum.faa.tsv","auxenochlorella_protothecoides.faa.tsv",
#"helicosporidium_sp.faa.tsv","candida_albicans.faa.tsv"]
rep_names = ["Prototheca"]
#"Chlorella Variabilis", "Trichophyton Rubrum", "Auxenochlorella Protothecoides", "Helicosporidium Sp",
#             "Candida Albicans"]
