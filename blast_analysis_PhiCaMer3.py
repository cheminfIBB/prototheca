...
names_phi = ["prototheca.phiscan", "chlorella_variabilis.phiscan","auxenochlorella_protothecoides.phiscan","helicosporidium_sp.phiscan","trichophyton_rubrum.phiscan","candida_albicans.phiscan"]
